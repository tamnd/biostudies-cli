...
```
biostudies <command> [arguments] [flags]
```

Run `biostudies <command> --help` for the full flag list on any command. This
...
per operation you declare in `biostudies/domain.go`.
